        ...
        Try
            With Me.spdOrderList
                ...
                For ix As Integer = 0 To r_dt.Rows.Count - 1
                    ...
                    .Col = .GetColFromID("outdt") : .Text = r_dt.Rows(ix).Item("outdt").ToString.Trim
                    ...
                    .Col = .GetColFromID("sr") : .Text = r_dt.Rows(ix).Item("sr").ToString.Trim
                    ...
                    .Col = .GetColFromID("filter") : .Text = r_dt.Rows(ix).Item("filter").ToString.Trim
    ...
    Private Sub sb_DisPlaySubData(ByVal riRow As Integer)
        Try
            ...
            With Me.spdOrderList
                ...
                .Col = .GetColFromID("rtnflg") : sRtnFlg = .Text.Trim
            ...
            ' 반납/폐기목록
            dt = CGDA_BT.fn_RtnList(sTnsnum, sFilter)
            sb_DisplayRtnList(dt)

            ' 출고 목록
            dt = CGDA_BT.fn_RtnOutList(sTnsnum)
        ...
        Try
            With spdRtnList
                ...
                For ix As Integer = 0 To r_dt.Rows.Count - 1
                    ...
                    .Col = .GetColFromID("remark") : .Text = r_dt.Rows(ix).Item("remark").ToString.Trim
                    .Col = .GetColFromID("tnsjubsuno") : .Text = r_dt.Rows(ix).Item("tnsjubsuno").ToString.Trim
                    .Col = .GetColFromID("comcd") : .Text = r_dt.Rows(ix).Item("comcd_out").ToString.Trim
                    .Col = .GetColFromID("comcdo") : .Text = r_dt.Rows(ix).Item("comcd").ToString.Trim
        ...
        Try
            With Me.spdOutList
                ...
                For ix As Integer = 0 To r_dt.Rows.Count - 1
                    ...
                    .Col = .GetColFromID("comcdo") : .Text = r_dt.Rows(ix).Item("comcdo").ToString
        ...
        Try
            ...
            With Me.spdOutList
                For ix As Integer = 1 To .MaxRows
                    ...
                    If sChk = "1"c Then
                        Dim lcls_Rtn As New clsTnsJubsu
                ...
                alRtnInfo = objHelp.fn_DisplayPop(Me, iGbn)

                Dim sRtnReqId As String = ""
                Dim sRtnReqNm As String = ""
                Dim sRtnCode As String = ""
                Dim sRtnCmt As String = ""
                Dim sCostyn As String = ""

                If alRtnInfo.Count < 1 Then
                    Return
                Else
                    sRtnReqId = alRtnInfo(0).ToString
                    sRtnReqNm = alRtnInfo(1).ToString
                    sRtnCode = alRtnInfo(2).ToString
                    sRtnCmt = alRtnInfo(3).ToString
                    sCostyn = alRtnInfo(4).ToString
                End If
                ...
                For i As Integer = 1 To .MaxRows
                    ...
                    If sChk = "1"c Then
                        Dim stuRtnInfo As New clsTnsJubsu
                        ...
                        stuRtnInfo.RTNREQID = sRtnReqId
                        stuRtnInfo.RTNREQNM = sRtnReqNm
                        stuRtnInfo.RTNCODE = sRtnCode
                        stuRtnInfo.RTNCMT = sRtnCmt
                        stuRtnInfo.ORDDATE = sOrddt
                        stuRtnInfo.SPCCD = sSpccd
                        stuRtnInfo.TEMP01 = sCostyn
