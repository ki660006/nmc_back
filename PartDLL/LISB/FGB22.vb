...
'/*                                                                                       */
'/* FileName     : FGB31.vb                                                               */
'/* PartName     : 혈액은행- 진료과별 X-Matching 현황                                     */
'/* Description  :                                                                        */
...
#Region " Windows Form 디자이너에서 생성한 코드 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FGB22))
...
#End Region
    ...
    Private Sub btnQuery_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnQuery.Click
        ...
        Try
            ' column - 성분제제
            Dim dt As DataTable = CGDA_BT.fnGet_XMatch_Com(Me.dtpDateS.Text.Replace("-", "").Replace(" ", ""), Me.dtpDateE.Text.Replace("-", "").Replace(" ", ""))
            ...
            With Me.spdData
                ...
                For ix As Integer = 0 To dt.Rows.Count - 1
                    .MaxCols = dt.Rows.Count + 2

                    .Row = 0
                    .Col = ix + 3 : .ColID = dt.Rows(ix).Item("comcd").ToString.Trim : .Text = dt.Rows(ix).Item("comnmd").ToString.Trim : .TypeHAlign = FPSpreadADO.TypeHAlignConstants.TypeHAlignCenter
                Next

                dt = CGDA_BT.fnGet_XMatch_DeptWithBld(Me.dtpDateS.Text.Replace("-", "").Replace(" ", ""), Me.dtpDateE.Text.Replace("-", "").Replace(" ", ""), "")
                ...
                For ix As Integer = 0 To dt.Rows.Count - 1
                    ...
                    If iCol > 0 Then
                        .Col = iCol : .Text = dt.Rows(ix).Item("cnt").ToString
                    End If
                Next

                '-- 가로 합계
                For iRow As Integer = 1 To .MaxRows
                    Dim lgCnt_x As Long = 0

                    .Row = iRow
                    For iCol As Integer = 3 To .MaxCols
                        .Col = iCol + 0 : lgCnt_x += CType(IIf(.Text = "", 0, .Text), Integer)
                    Next
                    .Col = 2 : .Text = lgCnt_x.ToString
                Next

                '-- 세로 합계
                .MaxRows += 1
                .Row = .MaxRows : .Col = 0 : .Text = "합 계" : .Col = 1 : .Text = "합 계"
                For iCol As Integer = 2 To .MaxCols
                    Dim lgCnt As Long = 0
    ...
    Private Sub btnExcel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExcel.Click
        With Me.spdData
            ...
            If Me.spdData.ExportToExcel("c:\진료과별X-Matching현황" + ".xls", "X-Matching 현황", "") Then
                Process.Start("c:\진료과별X-Matching현황" + ".xls")
            End If
    ...
    Private Sub FGB22_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        MdiTabControl.sbTabPageMove(Me)
    End Sub

    Private Sub FGB22_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub FGB22_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
