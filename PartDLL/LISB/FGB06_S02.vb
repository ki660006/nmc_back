...
Public Class FGB06_S02
    ...
    Private Sub btnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        Try
            ...
            Dim dt As DataTable = SData.fnGet_TnsOrdListNew(Me.dtpDate0.Value.ToString.Substring(0, 10).Replace("-", ""), Me.dtpDate1.Value.ToString.Substring(0, 10).Replace("-", ""), Me.txtRegno.Text, ls_Comcd, ls_TnsGbn)
            ...
            With Me.spdList
                ...
                If rsDt.Rows.Count > 0 Then
                    ...
                    For ix As Integer = 0 To rsDt.Rows.Count - 1
                        ...
                        .Col = .GetColFromID("comcdnm") : .Text = rsDt.Rows(ix).Item("ordnm").ToString
                        .Col = .GetColFromID("comnmd") : .Text = rsDt.Rows(ix).Item("comnmd").ToString
                        ...
                        .Col = .GetColFromID("remark") : .Text = rsDt.Rows(ix).Item("rmk").ToString
                        ...
                        .Col = .GetColFromID("tnsstrdt") : .Text = rsDt.Rows(ix).Item("fstrgstdt").ToString '<< JJH 혈액불출요청시간
