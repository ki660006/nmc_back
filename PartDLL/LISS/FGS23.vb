...
Public Class FGS23
    ...
    Private msFile_CalForm As String = Windows.Forms.Application.StartupPath & msXmlDir & "\FGS23_CALFORM.XML"
    ...
    Public Overridable Sub sbDisplay_List_Test()
        ...
        Try
            ...
            'dt = fnGet_Jubsu_Test(Me.dtpWkDayS.Text, Me.dtpWkDayE.Text, "1")
            ...
            '        .Row = 1
            '        .Col = ix + 2
            '        .Text = dt.Rows(ix).Item("warnm").ToString

            '    Next
            'End With


            'dt = fnGet_Jubsu_Test(Me.dtpWkDayS.Text, Me.dtpWkDayE.Text, "2")
            ...
            '    ' .MaxCols = 2
            '    Dim a As String = ""
            '    For ix As Integer = 0 To 24
            '        .Row = ix + 2
            '        .Col = 1
            '        If ix = 0 Or ix.ToString.Length = 1 Then
            '            .Text = "0" + ix.ToString
            '        Else
            '            .Text = ix.ToString
            '        End If
            ...
            '        For i1 As Integer = 0 To 24
            '            .Row = i1 + 2 : .Col = 1
            '            If .Text = dt.Rows(i).Item("tkh").ToString Then

            '                For i2 As Integer = 0 To 18
            '                    .Row = 1 : .Col = i2 + 2
            '                    If .Text = dt.Rows(i).Item("warnm").ToString Then
            '                        .Row = i1 + 2 : .Col = i2 + 2
            '                        .Text = dt.Rows(i).Item("cnt").ToString
            '                    End If
            '                Next
            ...
            dt = fnGet_Search_rst_count(Me.dtpWkDayS.Text, Me.dtpWkDayE.Text, Me.txtCalForm.Tag.ToString, mbMicroBioYn, Me.chkSpc.Checked, _
                                        IIf(Me.rdoOrgRst.Checked, "O", "V").ToString)
...
#Region " Windows Form 디자이너에서 생성한 코드 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FGS23))
        ...
        Me.spdList.Location = New System.Drawing.Point(-2, 3)
        Me.spdList.Name = "spdList"
        Me.spdList.OcxState = CType(resources.GetObject("spdList.OcxState"), System.Windows.Forms.AxHost.State)
        Me.spdList.Size = New System.Drawing.Size(1007, 480)
...
#End Region
    ...
    Private Sub spdList_ClickEvent(ByVal sender As Object, ByVal e As AxFPSpreadADO._DSpreadEvents_ClickEvent)
