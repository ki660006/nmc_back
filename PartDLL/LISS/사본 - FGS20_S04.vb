...
Public Class FGS20_S04
    ...
    Public Function DisplayForm(ByVal rarrRefList As ArrayList) As String
        Try
            ...
            If sSpc = "01" Then
                Me.chkBlood.Checked = True
            ElseIf sSpc = "02" Then
                Me.chkBodyflu.Checked = True
            ElseIf sSpc = "03" Then
                Me.chkUrine.Checked = True
            ElseIf sSpc = "04" Then
                Me.chkStool.Checked = True
            ElseIf sSpc = "05" Then
                Me.chkSputum.Checked = True
            ElseIf sSpc = "99" Then
            ...
            If sTest = "01" Then
                Me.chkSepa.Checked = True
            ElseIf sTest = "02" Then
                Me.chkPcr.Checked = True
            ElseIf sTest = "03" Then
                Me.chkAnti.Checked = True
            ElseIf sTest = "04" Then
                Me.chkKit.Checked = True
            ElseIf sTest = "99" Then
    ...
    Private Sub btnSend_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSend.Click
        ...
        Try
            ...
            If Me.chkBlood.Checked Then
                sSpccd = "01"
            ElseIf Me.chkBodyflu.Checked Then
                sSpccd = "02"
            ElseIf Me.chkUrine.Checked Then
                sSpccd = "03"
            ElseIf Me.chkStool.Checked Then
                sSpccd = "04"
            ElseIf Me.chkSputum.Checked Then
                sSpccd = "05"
            ElseIf Me.chkSpcEtc.Checked Then
                sSpccd = "99"
            End If
            ...
            If Me.chkSepa.Checked Then '11 검사방법
                sTest = "01"
            ElseIf Me.chkPcr.Checked Then
                sTest = "02"
            ElseIf Me.chkAnti.Checked Then
                sTest = "03"
            ElseIf Me.chkKit.Checked Then
                sTest = "04"
