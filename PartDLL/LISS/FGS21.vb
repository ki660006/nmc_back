...
Public Class FGS21
    ...
    Private Const msFile As String = "File : FGS21.vb, Class : S01" & vbTab
    Private msSlipFile As String = Application.StartupPath + msXML + "\FGS21_SLIP.XML"
    ...
    Private Sub sbSearch()
        ...
        Try
            Dim dt As DataTable = fnGet_MWDATA_List(Me.dtpTkDtS.Text.Replace("-", ""), Me.dtpTkDtE.Text.Replace("-", ""), Ctrl.Get_Code(cboPartSlip))
    ...
    Private Sub btnExcel_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExcel.Click
        ...
        Try
            ...
            With Me.spdList
                ...
                If .ExportToExcel("MWDATA.xls", "MWDATA list", "") Then
                    Process.Start("MWDATA.xls")
                End If
