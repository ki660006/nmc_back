...
Public Class FGS02
    ...
    Friend WithEvents chkIncludeChild As System.Windows.Forms.CheckBox
    ...
    Private Sub sbQuery()
        ...
        Try
            ...
            Dim dt As DataTable = fnGet_Tat_List(sTestCds, Me.dtpDate0.Text.Replace("-", ""), Me.dtpDate1.Text.Replace("-", ""), _
                                                 ...
                                                 Me.chkOVT.Checked, Ctrl.Get_Code(Me.cboSlip), sEmerYN, Me.txtRegNo.Text, Me.chkTATCont.Checked, _
            ...
            If dt.Rows.Count > 0 Then
                ...
                With spdList
                    ...
                    For ix As Integer = 0 To dt.Rows.Count - 1
                        ...
                        If dt.Rows(ix).Item("statgbn").ToString.Trim <> "" Then
                        ...
                        sngTAT1_MI_exp_holi = CSng(IIf(dt.Rows(ix).Item("tat1_mi_exp_holi").ToString.Trim = "", 0, dt.Rows(ix).Item("tat1_mi_exp_holi").ToString.Trim)) '20220104 jhs 휴일제회 추가


                        .Col = .GetColFromID("tat1") : .Text = dt.Rows(ix).Item("tat1").ToString.Trim
                        '<<<20170511 TAT시간에 걸린것 이 소수점이 있을경우 오버타임으로 계산되는것 막기 위해 소수점은l버림 추가 
                        ...
                        .Col = .GetColFromID("tat1_exp_holi") : .Text = dt.Rows(ix).Item("tat1_exp_holi").ToString.Trim
                        If Math.Truncate(sngTAT1_MI_exp_holi) > sngFRPTMI And sngFRPTMI > 0 Then
                            .ForeColor = System.Drawing.Color.Red
                            .BackColor = System.Drawing.Color.FromArgb(255, 202, 202)
                            '.Col = .GetColFromID("ovt1") : .Text = (Fix(sngTAT1_MI - sngPRPTMI)).ToString
                        End If
...
#Region " Windows Form 디자이너에서 생성한 코드 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.chkIncludeChild = New System.Windows.Forms.CheckBox()
        ...
        'chkIncludeChild
        '
        Me.chkIncludeChild.Anchor = CType((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.chkIncludeChild.AutoSize = True
        Me.chkIncludeChild.Location = New System.Drawing.Point(671, 17)
        Me.chkIncludeChild.Name = "chkIncludeChild"
        Me.chkIncludeChild.Size = New System.Drawing.Size(84, 16)
        Me.chkIncludeChild.TabIndex = 4
        Me.chkIncludeChild.Text = "차일드포함"
        Me.chkIncludeChild.UseVisualStyleBackColor = True
        '
        'Label9
        '
        ...
        Me.cboSlip.Size = New System.Drawing.Size(309, 20)
        ...
        Me.Panel2.Location = New System.Drawing.Point(756, 10)
        ...
        Me.btnCmtDel.CenterPtTracker = DesignerRectTracker11
        ...
        Me.btnCmtDel.ColorFillBlend = CBlendItems6
        ...
        Me.btnCmtDel.FocusPtTracker = DesignerRectTracker12
        ...
        DesignerRectTracker14.IsActive = True
...
#End Region
    ...
    Private Sub btnCdHelp_test_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCdHelp_test.Click
        ...
        Try
            ...
            '20210616 jhs 차일드코드 포함 
            'a_dr = dt.Select("tcdgbn IN ('P', 'B', 'S',)")
            Dim a_dr As DataRow()
            If chkIncludeChild.Checked Then
                a_dr = dt.Select("tcdgbn IN ('P', 'B', 'S','C')")
            Else
                a_dr = dt.Select("tcdgbn IN ('P', 'B', 'S',)")
            End If
            '-------------------------------------
