...
#Region " Windows Form 디자이너에서 생성한 코드 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.btnAddOr.BackColor = System.Drawing.SystemColors.Control
        ...
        'lblValue
        '
        Me.lblValue.BackColor = System.Drawing.Color.SlateGray
        ...
        'lblOps
        '
        Me.lblOps.BackColor = System.Drawing.Color.SlateGray
        ...
        Me.btnAddAnd.BackColor = System.Drawing.SystemColors.Control
        ...
        Me.btnAddSng.BackColor = System.Drawing.SystemColors.Control
        ...
        Me.cboOps.Items.AddRange(New Object() {"=", "<>", ">", ">=", "<", "<=", "is null", "is not null", "like *", "between"})
        ...
        'lblColumns
        '
        Me.lblColumns.BackColor = System.Drawing.Color.SlateGray
    ...
    Private Function fnFind_Syntax() As String
        ...
        Try
            ...
            Select Case sOpBuf.ToLower
                ...
                Case "is null"
                    sReturn = sColBuf + " is null"

                Case "is not null"
                    sReturn = sColBuf + " is not null"

                Case "start with"
                    sReturn = sColBuf + " like '" + r_txt.Text + "%'"
                ...
                Case "like", "like *"
                    'sReturn = sColBuf + " like '" + r_txt.Text + "%'"
                    sReturn = sColBuf + " >= '" + r_txt.Text + "' AND " + sColBuf + " <= '" + r_txt.Text + "z'"
                ...
                Case "between"
                    Dim sBuf As String = r_txt.Text
                    Dim sBuf_1 As String = ""
                    Dim sBuf_2 As String = ""

                    If sBuf.IndexOf("and") >= 0 Then
                        sBuf_1 = sBuf.Substring(0, sBuf.IndexOf("and")).Trim()
                    End If
                    ...
                    If sBuf_1 = "" Then Return ""

                    If sBuf.IndexOf("and") >= 0 Then
                        sBuf_2 = sBuf.Substring(sBuf.IndexOf("and") + 3).Trim()
                    End If
                    ...
                    If sBuf_2 = "" Then Return ""

                    sReturn = sColBuf + " between '" + sBuf_1 + "' and '" + sBuf_2 + "'"
