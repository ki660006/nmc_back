...
Imports LOGIN01.Login

Imports System.Windows.Forms
Imports System.Drawing

Public Class FGPISC02
    ...
    Private Sub sbDisplay_PatList(Optional ByVal rsRegNo As String = "")
        ...
        Try
            ...
            If rsRegNo = "" Then
                dt = DA01.OcsLink.Ord.fnGet_Coll_PatList(sIoGbn, Ctrl.Get_Code(cboDptOrWard), dtpDateS.Text, dtpDateE.Text, sSpcFlgS, sSpcFlgE)
                ...
                End If
            Else
                dt = DA01.OcsLink.Ord.fnGet_Coll_PatList_RegNo(rsRegNo, dtpDateS.Text, dtpDateE.Text, sSpcFlgS, sSpcFlgE)
            ...
            With spdList
                ...
                For ix As Integer = 0 To dt.Rows.Count - 1
                    cpi = DA01.OcsLink.Ord.fnSet_PatInfo(dt.Rows(ix), dtSysDate)
    ...
    Private Sub sbDisplay_Ward()
        ...
        Try
            Dim dt As DataTable = DA01.OcsLink.SData.fnGet_WardList()
    ...
    Private Sub sbDisplay_Dept()
        ...
        Try
            Dim dt As DataTable = DA01.OcsLink.SData.fnGet_DeptList()
    ...
    Public Sub New(ByVal rsUseId As String, ByVal rsUsrNm As String, ByVal rsWardNo As String, ByVal rsRegNo As String, ByVal r_DbCn As OleDb.OleDbConnection, ByRef rsErrMsg As String)
        ...
        Try
            If r_DbCn Is Nothing Then
                DA01.DA_R.fnGet_DbConnect()
                rsErrMsg = "OK"
            Else
                rsErrMsg = fnDb_Setting(r_DbCn)
            End If
    ...
    Private Sub FGC020010_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Me.lblBarPrinter.Text = (New DA01.DataAccess.BCPrinter(Me.Name)).GetInfo.PRTNM
    ...
    Private Sub txtPatNm_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtPatNm.KeyDown
        ...
        Try
            ...
            Dim dt As DataTable = DA01.OcsLink.Pat.fnGet_PatInfo_byNm(Me.txtPatNm.Text)
    ...
    Private Sub btnPrint_Set_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint_Set.Click
        ...
        Dim objFrm As New POPUPPRT.FGPWIN02(msFormNm)
