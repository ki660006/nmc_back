...
Public Class FGM03
    ...
    Private Const msFile As String = "File : FGM03.vb, Class : FGM03" & vbTab
    Private Const msXMLDir As String = "\XML"
    Private msTestFile As String = Application.StartupPath & msXMLDir & "\FGM03_TEST.XML"
    Private msWkGrpFile As String = Application.StartupPath & msXMLDir & "\FGM03_WKGRP.XML"
    Private msTgrpFile As String = Application.StartupPath & msXMLDir & "\FGM03_TGRP.XML"
    Private msQryFile As String = Application.StartupPath & msXMLDir & "\FGM03_Qry.XML"
...
#Region " Windows Form 디자이너에서 생성한 코드 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FGM03))
        ...
        Me.GroupBox22.Size = New System.Drawing.Size(864, 81)
        ...
        Me.lblSearch.Location = New System.Drawing.Point(364, 56)
        ...
        Me.txtBcNo.Location = New System.Drawing.Point(437, 56)
        ...
        Me.dtpDateE.Location = New System.Drawing.Point(199, 56)
        ...
        Me.lblWk.Location = New System.Drawing.Point(219, 60)
        Me.lblWk.Name = "lblWk"
        ...
        Me.txtWkNoE.Location = New System.Drawing.Point(233, 56)
        ...
        Me.txtWkNoS.Location = New System.Drawing.Point(183, 56)
        ...
        Me.Label1.Location = New System.Drawing.Point(186, 60)
        ...
        Me.dtpDateS.Location = New System.Drawing.Point(79, 56)
        ...
        Me.btnHelp_Test.Location = New System.Drawing.Point(491, 34)
        ...
        Me.cboTGrp.Location = New System.Drawing.Point(163, 34)
        ...
        Me.cboQryGbn.Location = New System.Drawing.Point(79, 34)
        ...
        Me.lblTnmd.Location = New System.Drawing.Point(513, 34)
        ...
        Me.txtTestCd.Location = New System.Drawing.Point(437, 34)
        ...
        Me.lblTItem.Location = New System.Drawing.Point(364, 34)
        ...
        Me.cboWkGrp.Location = New System.Drawing.Point(163, 34)
        ...
        Me.lblTitleDt.Location = New System.Drawing.Point(6, 56)
        ...
        Me.lblNgCd.Location = New System.Drawing.Point(6, 11)
        ...
        Me.cboNgCd.Location = New System.Drawing.Point(123, 11)
...
#End Region
    ...
    Private Function fnFind_Enable_NgCd(ByVal rsBcNo As String, ByVal rsTkDt As String) As Boolean
        Dim sFn As String = "fnFind_Enable_NgCd"

        Try
            Dim sUsDt As String = ma_dr_NgCd(Me.cboNgCd.SelectedIndex).Item("usdt").ToString
            Dim sUeDt As String = ma_dr_NgCd(Me.cboNgCd.SelectedIndex).Item("uedt").ToString

            If sUsDt <= rsTkDt And sUeDt > rsTkDt Then
                msBcNo_Err_Ng = ""

                Return True
            Else
                Dim sMsg As String = ""
                sUsDt = sUsDt.Insert(4, "-").Insert(7, "-").Insert(10, " ").Insert(13, ":").Insert(16, ":")
                sUeDt = sUeDt.Insert(4, "-").Insert(7, "-").Insert(10, " ").Insert(13, ":").Insert(16, ":")
                Dim sTkDt As String = rsTkDt.Insert(4, "-").Insert(7, "-").Insert(10, " ").Insert(13, ":").Insert(16, ":")

                sMsg += "선택한 " + Me.lblNgCd.Text + "의 시작일시는 " + sUsDt + ", 종료일시는 " + sUeDt + "이고" + vbCrLf
                sMsg += "검체번호(" + rsBcNo + ") 의 접수일시는 " + sTkDt + " 로 사용할 수 없습니다!!"

                If Not msBcNo_Err_Ng = rsBcNo Then
                    MsgBox(sMsg)
                End If

                msBcNo_Err_Ng = rsBcNo
    ...
    Private Sub sbDisplay_NogrowthCd()
        ...
        Try
            ...
            Dim dt As DataTable = LISAPP.APP_M.CommFn.fnGet_BacCd

            If dt.Rows.Count < 1 Then Return

            Dim sFilter As String = ""

            sFilter += "bacgencd = '" + FixedVariable.gsBacGenCd_Nogrowth + "' AND "
            sFilter += "usdt <= '" + New LISAPP.APP_DB.ServerDateTime().GetDateTime24.Replace("-", "").Replace(":", "").Replace(" ", "") + "' AND "
            sFilter += "uedt > '" + New LISAPP.APP_DB.ServerDateTime().GetDateTime24.Replace("-", "").Replace(":", "").Replace(" ", "") + "'"

            ma_dr_NgCd = dt.Select(sFilter, "baccd asc")

            For i As Integer = 1 To ma_dr_NgCd.Length
                With Me.cboNgCd
                    .Items.Add("[" + ma_dr_NgCd(i - 1).Item("baccd").ToString() + "] " + ma_dr_NgCd(i - 1).Item("bacnmd").ToString())
                End With
            Next

            If sNgCd_Pre = "" Then Return

            For i As Integer = 1 To Me.cboNgCd.Items.Count
                If Me.cboNgCd.Items.Item(i - 1).ToString() = sNgCd_Pre Then
                    Me.cboNgCd.SelectedIndex = i - 1

                    Exit For
                Else
                    Me.cboNgCd.SelectedIndex = -1
                End If
            Next
            ...
            With spd
                ...
                For i As Integer = 1 To .MaxRows
                    ...
                    If sChk = "1" Then
                        ...
                        ri_b.TestCd = sTestCD
                        ri_b.SpcCd = sSpcCd
                        ri_b.BacGenCd = FixedVariable.gsBacGenCd_Nogrowth
                        ri_b.BacCd = sBacCd
                        ri_b.BacSeq = "1"
                        ri_b.Ranking = "1"
                        ri_b.TestMtd = ""
    ...
    Private Sub FGM03_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub FGM03_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
