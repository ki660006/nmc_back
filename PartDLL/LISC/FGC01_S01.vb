...
Public Class FGC01_S01
    Inherits System.Windows.Forms.Form

    Private Const msFile As String = "File : FGC01_S01.vb, Class : LISC.FGC01_S01" + vbTab
    ...
    Private Sub txtBcNo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtBcNo.KeyDown
        ...
        Try
            ...
            With (New LISAPP.APP_C.CollReg)
                Dim blnRet As Boolean = .ExecuteDo_CollDt(sBcNo, Me.chkAutoTk.Checked)
