...
Public Class FGC22
    ...
    Private Const msFile As String = "File : FGC22.vb, Class : FGC22" & vbTab

    Private msFormNm As String = "FGC22"
    ...
    Private Sub sbDisplay_PatList(Optional ByVal rsRegNo As String = "")
        ...
        Try
            ...
            If rsRegNo = "" Then
                dt = PISAPP.DPIS01.OcsLink.Ord.fnGet_Coll_PatList(sIoGbn, Ctrl.Get_Code(cboDptOrWard), dtpDateS.Text, dtpDateE.Text, sSpcFlgS, sSpcFlgE)
    ...
    Private Sub sbDisplay_Ward()
        ...
        Try
            ...
            For ix As Integer = 0 To dt.Rows.Count - 1
                cboDptOrWard.Items.Add("[" + dt.Rows(ix).Item("wardno").ToString + "] " + dt.Rows(ix).Item("wardnm").ToString)
            Next
    ...
    Private Sub sbDisplay_Dept()
        ...
        Try
            ...
            For ix As Integer = 0 To dt.Rows.Count - 1
                cboDptOrWard.Items.Add("[" + dt.Rows(ix).Item("deptcd").ToString + "] " + dt.Rows(ix).Item("deptnm").ToString)
            Next
    ...
    Private Sub FGC22_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub FGC220010_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub FGC22010_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
    ...
    Private Sub btnOrdSum_Click(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    Private Sub btnQuery_rst_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim sFn As String = "Handles btnQuery_rst.ButtonClick"

        Dim frm As Windows.Forms.Form

        frm = New R02.FGRV01(axPatInfo.RegNo, "", "")
        frm.Activate()
        frm.Show()
    ...
    Private Sub btnQuery_Cancel_Click(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    Private Sub btnHistory_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim sFn As String = "Handles btnResult.ButtonClick"

        Dim frmChild As Windows.Forms.Form
        frmChild = New S01.FGS06(Me.axPatInfo.RegNo, Me.dtpDateS.Text, Me.dtpDateE.Text)
