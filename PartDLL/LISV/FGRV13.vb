...
Public Class FGRV13
    ...
    Private Const msFile As String = "File : FGRV13.vb, Class : FGRV13 & vbTab"
    ...
    Private msTestFile As String = Application.StartupPath & msXML & "\FGRV13_TEST.XML"
    Private msTermFile As String = Application.StartupPath + msXML + "\FGRV13_TERM.XML"
    ...
    Public Sub sbDisplay_Data(ByVal rsRegNo As String)
        ...
        Try
            ...
            With spdSlip
                ...
                If .MaxRows > 0 Then spdSlip_ClickEvent(spdSlip, New AxFPSpreadADO._DSpreadEvents_ClickEvent(.GetColFromID("slipnm"), 1))
            End With
    ...
    Private Sub sbDisplay_Data_rst(ByVal rsRegNo As String, ByVal rsSlipCd As String, ByVal rsTestCds As String)
        ...
        Try
            ...
            dt = LISAPP.APP_V.CommFn.fnGet_history_rst_rv(IIf(Me.lblDate.Text.StartsWith("접수"), "J", "O").ToString, rsRegNo, sTestCds, Me.dtpDayS.Text, Me.dtpDayE.Text, dt_Micro, rsSlipCd)
            ...
            Else
                Me.SplitContainer1.SplitterDistance = CInt(Me.SplitContainer1.Height * 0.8)
    ...
    Private Sub sbDisplay_SpcInfo(ByVal r_dt As DataTable)
        ...
        Try
            ...
            Dim iAgeCvr As String = ""
            If iAge = 0 Then

                Dim iDage As Integer = 0
                iDage = CType(DateDiff(DateInterval.Day, dtBirthDay, dtSysDate), Integer)
                If iDage <= 31 Then
                    iAgeCvr = CType(iDage, String) + "/d"
                ElseIf iDage < 365 Then

                    iAgeCvr = CType(Convert.ToInt32(Val(iDage / 30)), String) + "m"
                End If
            Else
                iAgeCvr = CType(iAge, String)
            End If
            '>
            ...
            If r_dt.Rows(0).Item("sexage").ToString.Trim = "" And sPatInfo.Length > 1 Then
                ...
                r_si.SexAge = sPatInfo(1) + "/" + iAgeCvr
            Else
...
#Region " Windows Form 디자이너에서 생성한 코드 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FGRV13))
        ...
        Me.Panel1.Size = New System.Drawing.Size(863, 309)
        ...
        Me.spdResult.Size = New System.Drawing.Size(861, 306)
        ...
        Me.Panel2.Location = New System.Drawing.Point(1, 252)
        Me.Panel2.Name = "Panel2"
        Me.Panel2.Size = New System.Drawing.Size(278, 359)
        ...
        Me.Panel3.Location = New System.Drawing.Point(1040, 5)
        ...
        Me.SplitContainer1.Size = New System.Drawing.Size(863, 491)
        ...
        Me.pnlMicro.Size = New System.Drawing.Size(863, 178)
        ...
        Me.spdMicro.Size = New System.Drawing.Size(863, 178)
        ...
        Me.rstChart1.RefTxt = ""
        Me.rstChart1.RegNo = ""
        Me.rstChart1.Size = New System.Drawing.Size(863, 178)
        ...
        Me.btnSearchOR.Location = New System.Drawing.Point(141, 88)
        Me.btnSearchOR.Name = "btnSearchOR"
        Me.btnSearchOR.Size = New System.Drawing.Size(137, 24)
        Me.btnSearchOR.TabIndex = 9
        ...
        Me.btnSearchR.Location = New System.Drawing.Point(3, 88)
        Me.btnSearchR.Name = "btnSearchR"
        Me.btnSearchR.Size = New System.Drawing.Size(137, 24)
        Me.btnSearchR.TabIndex = 8
        ...
        Me.btnClear_test.Location = New System.Drawing.Point(2, 230)
        ...
        Me.txtSelTest.Location = New System.Drawing.Point(75, 207)
        Me.txtSelTest.Multiline = True
        Me.txtSelTest.Name = "txtSelTest"
        Me.txtSelTest.ReadOnly = True
        Me.txtSelTest.Size = New System.Drawing.Size(204, 44)
        ...
        Me.axItemSave.Location = New System.Drawing.Point(3, 116)
        Me.axItemSave.Margin = New System.Windows.Forms.Padding(1)
        Me.axItemSave.Name = "axItemSave"
        Me.axItemSave.Size = New System.Drawing.Size(276, 89)
        ...
        Me.axPatInfo.Location = New System.Drawing.Point(284, 1)
        Me.axPatInfo.Name = "axPatInfo"
        Me.axPatInfo.Size = New System.Drawing.Size(754, 116)
...
#End Region
    ...
    Private Sub FGRV13_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Dim sFn As String = ""
    ...
    '<----- Control Event ----->
    Private Sub FGRV13_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            ...
            With spdResult
                ...
                .Col = 2
                .Row = 3
                .Text = "등록번호 : " + msRegNo + Space(10) + "성명 : " + sPatnm + Space(10) + "성별/나이 : " + sSexage
                .FontBold = True
    ...
    Private Sub spdResult_ClickEvent(ByVal sender As Object, ByVal e As AxFPSpreadADO._DSpreadEvents_ClickEvent) Handles spdResult.ClickEvent
        ...
        Try
            With spdResult
                .Row = e.row
                '.Col = .GetColFromID("unit") + 1 'e.col '<20140724 클릭검체의 나이표현
                .Col = e.col
    ...
    Public Sub btnSearchR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearchR.Click, btnSearchOR.Click
...
#End If
    ...
    Private Sub FGRV13_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        Dim sFn As String = "Handles Me.Shown"
        Try
            Me.txtNo.Focus()
    ...
    Private Sub spdSlip_ContextMenuStripChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles spdSlip.ContextMenuStripChanged
