...
#Region " Windows Form 디자이너에서 생성한 코드 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.dtpUETime.Location = New System.Drawing.Point(214, 93)
        ...
        Me.dtpUEDate.Location = New System.Drawing.Point(125, 93)
        ...
        'lblMsg
        '
        Me.lblMsg.BackColor = System.Drawing.Color.FromArgb(CType(CType(236, Byte), Integer), CType(CType(242, Byte), Integer), CType(CType(255, Byte), Integer))
        ...
        Me.btnReg.Location = New System.Drawing.Point(117, 128)
        ...
        Me.btnCancel.Location = New System.Drawing.Point(215, 128)
...
#End Region
    ...
    Private Sub FGF02_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.dtpUEDate.Value = CType(Format(DateAdd(DateInterval.Day, 1, Now), "yyyy-MM-dd") & " 00:00:00", Date)
        Me.dtpUETime.Value = CType(Format(DateAdd(DateInterval.Day, 1, Now), "yyyy-MM-dd") & " 00:00:00", Date)
        msAction = "NO"
    End Sub
