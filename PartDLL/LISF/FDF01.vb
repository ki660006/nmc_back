...
Public Class FDF01
    ...
    Private Function fnFindConflict(ByVal rsBcclsCd As String, ByVal rsUsDt As String) As String
        ...
        Try
            ...
            If dt.Rows.Count > 0 Then
                Return "시작일시가 " + dt.Rows(0).Item(0).ToString + dt.Rows(0).Item("partgbn").ToString + "인 동일 바코드분류 코드가 존재합니다." + vbCrLf + vbCrLf + _
                       "시작일시를 재조정 하십시요!!"
            Else
                Return ""
            End If
    ...
    Private Function fnFindConflict_BC(ByVal rsBcclsCd As String, ByVal rsUsDt As String, ByVal rsBcclsnmbp As String, Optional ByVal riRegType As Integer = 0) As String
        ...
        Try
            ...
            If riRegType = 0 Then '신규
                ...
                If dt.Rows.Count > 0 Then
                    Return "바코드분류코드나 출력명(바코드)가 기존 바코드분류코드 : " + dt.Rows(0).Item(0).ToString + dt.Rows(0).Item("partgbn").ToString + "와 동일합니다." + vbCrLf + vbCrLf + _
                           "바코드분류코드나 출력명(바코드)를 수정 하십시요!!"
                Else
                    Return ""
                End If
    ...
    Public Function fnValidate() As Boolean
        ...
        Try
            If Len(Me.txtBcclsCd.Text.Trim) < 1 Then
                MsgBox("바코드분류코드를 (정확히) 입력하여 주십시요!!", MsgBoxStyle.Critical)
                Exit Function
            End If
            ...
            If Me.txtBcclsNm.Text.Trim = "" Then
                MsgBox("바코드분류명을 입력하여 주십시요!!", MsgBoxStyle.Critical)
                Exit Function
            End If

            If Me.txtBcclsNmS.Text.Trim = "" Then
                MsgBox("바코드분류명(약어)를 입력하여 주십시요!!", MsgBoxStyle.Critical)
                Exit Function
            End If

            If txtBcclsNmD.Text.Trim = "" Then
                MsgBox("바코드분류명(화면)을 입력하여 주십시요!!", MsgBoxStyle.Critical)
                Exit Function
            End If

            If Me.txtBcclsNmP.Text.Trim = "" Then
                MsgBox("바코드분류명(출력)을 입력하여 주십시요!!", MsgBoxStyle.Critical)
                Exit Function
            End If

            If Me.txtTBcclsNmBP.Text.Trim = "" Then
                MsgBox("바코드분류명(바코드)를 입력하여 주십시요!!", MsgBoxStyle.Critical)
                Exit Function
            End If

            If Not IsNumeric(Me.txtTBcclsNmBP.Text.Trim) Then
                MsgBox("바코드분류명(바코드)를 숫자로 입력하여 주십시요!!", MsgBoxStyle.Critical)
                Exit Function
            End If
...
#Region " Windows Form 디자이너에서 생성한 코드 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.lblBcclsGbn.Font = New System.Drawing.Font("굴림체", 9.0!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(129, Byte))
        ...
        Me.cboBcclsGbn.Items.AddRange(New Object() {"[0] ", "[1] 종합검증", "[2] 미생물", "[3] 혈액은행", "[6] 위탁검체", "[7] 성분제제", "[8] 핵의학", "[9] 병리과"})
        ...
        Me.cboColorGbn.Items.AddRange(New Object() {"[0] 흰색", "[1] 노랑색", "[2] 보라색", "[3] 주황색"})
        ...
        Me.lblBcclsNmBP.Font = New System.Drawing.Font("굴림체", 9.0!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(129, Byte))
        ...
        Me.lblBcclsNmBP.Text = "바코드분류출력명(바코드)"
        ...
        Me.txtBcclsNmS.Font = New System.Drawing.Font("굴림체", 9.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(129, Byte))
        ...
        Me.txtTBcclsNmBP.Font = New System.Drawing.Font("굴림체", 9.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(129, Byte))
        ...
        Me.txtBcclsNmP.Font = New System.Drawing.Font("굴림체", 9.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(129, Byte))
        ...
        Me.txtBcclsNmD.Font = New System.Drawing.Font("굴림체", 9.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(129, Byte))
        ...
        Me.txtBcclsNm.Font = New System.Drawing.Font("굴림체", 9.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(129, Byte))
        ...
        Me.txtBcclsCd.Font = New System.Drawing.Font("굴림체", 9.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(129, Byte))
...
#End Region
    ...
    Private Sub btnUE_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUE.Click
        ...
        Try
            ...
            Dim sMsg As String = "   바코드분류코드   : " + Me.txtBcclsCd.Text + vbCrLf
            sMsg += "   바코드분류명     : " + Me.txtBcclsNm.Text + vbCrLf
            sMsg += "   을(를) 사용종료하시겠습니까?"
