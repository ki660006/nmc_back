...
Public Class FDF53
    ...
    Private Function fnCollectItemTable_53(ByVal rsRegDt As String) As LISAPP.ItemTableCollection
        ...
        Try
            ...
            With it53
                .SetItemTable("refcd", 1, 1, Me.txtRefcd.Text)
                .SetItemTable("refnm", 2, 1, Me.txtRefnm.Text)
                ...
                .SetItemTable("refnmd", 7, 1, Me.txtRefnmd.Text)
                .SetItemTable("group", 8, 1, Ctrl.Get_Code(cboGroup))
                .SetItemTable("seq", 9, 1, Me.txtSeq.Text)
    ...
    Public Function fnReg() As Boolean
        ...
        Try
            ...
            it53 = fnCollectItemTable_53(sRegDT)

            If mobjDAF.TransRefInfo(it53, iRegType10, Me.txtRefcd.Text, Me.txtUSDay.Text.Replace("-", "") + Format(dtpUSTime.Value, "HHmmss").ToString, USER_INFO.USRID) Then
                fnReg = True
            Else
                fnReg = False
            End If
    ...
    Private Sub sbDisplayCdDetail_Ref(ByVal rsRefCd As String)
        ...
        Try
            ...
            Dim dt As DataTable = mobjDAF.GetRefInfo(rsRefCd)
