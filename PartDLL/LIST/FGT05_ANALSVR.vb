...
Public Class FGT05_ANALSVR

    Friend fbForceClose As Boolean = False
    Friend mbAnalyzing As Boolean = False

    Public Function fnDisplay_ResultOfAnalysis() As Integer

        Try
            Dim dtStDayB As Date = Me.dtpDayB.Value
            Dim dtStDayE As Date = Me.dtpDayE.Value
            ...
            Dim dt As DataTable = (New LISAPP.APP_T.SrhFn).fnGet_M_AnalysisInfo(Me.dtpDayB.Text.Replace("-", ""), Me.dtpDayE.Text.Replace("-", ""), "-")
            ...
            With Me.spdList
                ...
                .MaxRows = dtStDayE.Subtract(dtStDayB).Days + 1

                For i As Integer = 1 To dtStDayE.Subtract(dtStDayB).Days + 1
                    .Col = .GetColFromID("styymmdd")
                    .Row = i
                    .Text = dtStDayB.AddDays(i - 1).ToString("yyyy-MM-dd")

                    Dim a_dr As DataRow() = dt.Select("styymmdd = '" + dtStDayB.AddDays(i - 1).ToString("yyyyMMdd") + "'")
    ...
    Public Sub Exec_Analysis()
        ...
        Try
            ...
            For i As Integer = 1 To al_StDay.Count
                ...
                Dim sReturn As String = (New LISAPP.APP_T.ExecFn).fnExe_Micro_Statistics(al_StDay(i - 1).ToString.Replace("-", ""))
    ...
    '> Control Event
    Private Sub FGT05_ANAL_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        If fbForceClose Then Return
    ...
    Private Sub FGT05_ANALSVR_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub FGT05_ANAL_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
