...
Public Class FGT04_ANALSVR
    Friend fbForceClose As Boolean = False
    Friend fbAnalyzing As Boolean = False

    Public Function Display_ResultOfAnalysis() As Integer
        ...
        Try
            ...
            Dim dt As DataTable = (New LISAPP.APP_T.SrhFn).fnGet_Final_AnalysisInfo(Me.dtpDayB.Text.Replace("-", ""), Me.dtpDayB.Text.Replace("-", ""), "-")
    ...
    Public Sub Exec_Analysis()
        ...
        Try
            ...
            For i As Integer = 1 To al_StDay.Count
                ...
                Dim sReturn As String = (New LISAPP.APP_T.ExecFn).fnExe_Final_Statistics(al_StDay(i - 1).ToString.Replace("-", ""))
    ...
    '> Control Event
    Private Sub FGT04_ANAL_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub FGT04_ANALSVR_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub FGT04_ANAL_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
