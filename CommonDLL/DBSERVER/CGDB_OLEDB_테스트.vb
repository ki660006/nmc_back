        ...
        Try
            ...
            If m_DbCn.State = ConnectionState.Closed Then
                ...
                If stuCStr.USERID <> "" Then
                    Fn.log("YEJ:" + stuCStr.USERID + "/" + stuCStr.PASSWORD)

                    'If stuCStr.DATASOURCE.StartsWith("ORADEV_Test_107") And iCnt = 0 Then        '-- MJOCS
                    '    If stuCStr.DATASOURCE = "ORADEV_Test_107" Then                             '-- MJOCS2
                    '        If Not MdiMain.Frm Is Nothing Then
                    '            MdiMain.Frm.Text.Replace("ORADEV_Test_107", "ORADEV_Test_107")    '-- MJOCS2, MJOCS1
                    '        End If
                    '    End If

                    '    stuCStr.DATASOURCE = "ORADEV_Test_107"                                     '-- MJOCS1
                    'End If
        ...
        Catch ex As Exception
            ...
            If iCnt <= 3 Then
                ...
                With stuCStr
                    ...
                    If .DATASOURCE = "ORADEV_Test_107" Then  '-- MJOCS1
                        .DATASOURCE = "ORADEV_Test_107"           '-- MJ0CS2

                        If Not MdiMain.Frm Is Nothing Then
                            MdiMain.Frm.Text.Replace("ORADEV_Test_107", "ORADEV_Test_107")  '-- MJOCS1, MJOCS2
                        End If
                        '> add freety 2005/01/10
                    Else
                        .DATASOURCE = "ORADEV_Test_107"              '-- MJOCS1
