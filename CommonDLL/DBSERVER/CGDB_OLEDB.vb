    ...
    Public Shared Sub OleDbConnection()
        ...
        Try
            ...
            If m_DbCn.State = ConnectionState.Closed Then
                stuCStr = (New COMMON.CommDb.Info).GetConnStr_mssql_scl
        ...
        Catch ex As Exception
            ...
            If iCnt <= 4 Then
                ...
                With stuCStr
                    ...
                    If .DATASOURCE = "172.16.6.27" Then  '-- MJOCS1
                        .DATASOURCE = "172.16.6.27"           '-- MJ0CS2

                        If Not MdiMain.Frm Is Nothing Then
                            MdiMain.Frm.Text.Replace("172.16.6.27", "172.16.6.27")  '-- MJOCS1, MJOCS2
                        End If
                        '> add freety 2005/01/10
                    Else
                        .DATASOURCE = "172.16.6.27"              '-- MJOCS1

                        If Not MdiMain.Frm Is Nothing Then
                            MdiMain.Frm.Text.Replace("172.16.6.27", "172.16.6.27")  '-- MJOCS2, MJOCS1
                        End If
                    End If
