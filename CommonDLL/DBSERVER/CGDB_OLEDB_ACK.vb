        ...
        Try
            ...
            If m_DbCn.State = ConnectionState.Closed Then
                ...
                If stuCStr.USERID <> "" Then
                    If stuCStr.DATASOURCE.StartsWith("14.35.234.249") And iCnt = 0 Then        '-- MJOCS
                        If stuCStr.DATASOURCE = "14.35.234.249" Then                             '-- MJOCS2
                            If Not MdiMain.Frm Is Nothing Then
                                MdiMain.Frm.Text.Replace("14.35.234.249", "14.35.234.249")    '-- MJOCS2, MJOCS1
                            End If
                        End If

                        stuCStr.DATASOURCE = "14.35.234.249"                                     '-- MJOCS1
                    End If
        ...
        Catch ex As Exception
            ...
            If iCnt <= 4 Then
                ...
                With stuCStr
                    ...
                    If .DATASOURCE = "14.35.234.249" Then  '-- MJOCS1
                        .DATASOURCE = "14.35.234.249"           '-- MJ0CS2

                        If Not MdiMain.Frm Is Nothing Then
                            MdiMain.Frm.Text.Replace("14.35.234.249", "14.35.234.249")  '-- MJOCS1, MJOCS2
                        End If
                        '> add freety 2005/01/10
                    Else
                        .DATASOURCE = "14.35.234.249"              '-- MJOCS1
