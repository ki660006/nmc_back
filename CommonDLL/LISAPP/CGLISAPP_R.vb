...
Namespace APP_R
    ...
    Public Class AxRstFn
        ...
        Public Function fnGet_ImgFile_List_New(ByVal rsDateS As String, ByVal rsDateE As String, ByVal rsID As String, Optional ByVal rsBcnoList As String = "",
                                                    Optional ByVal rsRstchk As Boolean = False) As DataTable
            Dim sFn As String = "Public Function fnGet_ImgFile_List_New(ByVal rsDateS As String, ByVal rsDateE As String, ByVal rsID As String, Optional ByVal rsBcnoList As String = "",
                                                    Optional ByVal rsRstchk As Boolean = False) As DataTable"
            Try
                Dim sSql As String = ""
                Dim al As New ArrayList
                ...
                sSql += "          j.patnm patnm, a.testcd, "
                sSql += "          NVL2 (s13.bcno, 'O', 'X') imgchk "
                sSql += "     FROM (SELECT "

                If rsRstchk Then
                    sSql += "       /*+ leading(r) index(r idx_lr010m_4) use_hash(f) */ "
                Else
                    sSql += "       /*+ leading(r) index(r idx_lr010m_3) use_hash(f) */ "
                End If

                sSql += "               r.bcno, r.tkdt, r.testcd, r.spccd, r.wkymd, r.fnid "
                sSql += "             FROM lr010m r, lf060m f"
                ...
                If rsID <> "" Then
                    sSql += "           AND fnid = :fnid"
                    al.Add(New OracleParameter("fnid", OracleDbType.Varchar2, rsID.Length, ParameterDirection.Input, Nothing, Nothing, Nothing, Nothing, DataRowVersion.Current, rsID))
                End If
                ...
                sSql += "           ) a, lj010m j, lf310m f3, lrs13m s13 "
                sSql += "      WHERE a.bcno = j.bcno "
                sSql += "        AND j.spcflg = '4' "
                sSql += "        AND a.testcd = f3.testcd "
                sSql += "        AND a.bcno = s13.bcno(+) "
                sSql += "   ORDER BY bcno"
