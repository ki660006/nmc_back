...
Public Class FGPOPUPST_PLASMA_aPPT
    ...
    Private Function fnGet_Report() As String
        ...
        Try
            ...
            sValues += Space(27) + Me.lblptsample.Text + Space(1) + Me.txtPtSample.Text + Me.lblsec1.Text + vbCrLf
            sValues += Space(27) + Me.lblNomalc.Text + Space(1) + Me.txtnormal.Text + Me.lblsec2.Text + vbCrLf + vbCrLf
...
Public Class DA_ST_PLASMA_aPPT
