...
Public Class FGPOPUPST_VCMT
    Inherits System.Windows.Forms.Form

    Private Const mc_sFile As String = "File : FGPOPUPST_VCMT.vb, Class : FGPOPUPST_VCMT" & vbTab
...
#Region " Windows Form 디자이너에서 생성한 코드 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FGPOPUPST_VCMT))
        ...
        Me.txtCdAll.Text = "123456789012345678901234567890123456789012345678901234567890123456789012345678901" & _
        ...
        Me.Label1.Location = New System.Drawing.Point(112, 236)
        ...
        Me.btnDel.Location = New System.Drawing.Point(704, 278)
        Me.btnDel.Name = "btnDel"
        Me.btnDel.Size = New System.Drawing.Size(96, 36)
        ...
        Me.btnReg.Location = New System.Drawing.Point(704, 236)
        Me.btnReg.Name = "btnReg"
        Me.btnReg.Size = New System.Drawing.Size(96, 36)
        ...
        Me.Name = "FGPOPUPST_VCMT"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.Manual
        Me.Text = "종합검증 모듈 ː 검증/판독소견"
...
#End Region
        ...
        Try
            ...
            If sBuf.IndexOf(Convert.ToChar(1)) >= 0 Then
                ...
                For i As Integer = 1 To sBuf.Split(Convert.ToChar(1)).Length
                    If sTmp.Length > 0 Then sTmp += msCrLf + sLeftMargin
    ...
    Private Sub sbDel()
        ...
        Try
            ...
            Dim sMsg As String = "코드 : " + sCdSeq + ", 제목 : " + sCdTitle + msCrLf + msCrLf

            If MsgBox("삭제하시겠습니까?", MsgBoxStyle.YesNo Or MsgBoxStyle.DefaultButton2, Me.Text) = MsgBoxResult.No Then
                Return
            End If

            If (New DA_V).Del_CdList(m_dbCn, psCdSep, sCdSeq, msUsrID) Then
                sbDisplayInit_Cd()
    ...
    Private Sub sbReg()
        ...
        Try
            ...
            If (New DA_V).Set_CdList(m_dbCn, psCdSep, sCdSeq, sCdTitle, sCdCont, msUsrID) Then
                '재조회
                sbDisplay_CdList()
            End If
    ...
    Private Sub sbDisplay_CdList()
        ...
        Try
            ...
            If chkAll.Checked = True Then
                dt = (New DA_V).Get_CdList(m_dbCn, Me.rdoAll.Checked, psCdSep, sField, sValue, "")
            Else
                dt = (New DA_V).Get_CdList(m_dbCn, Me.rdoAll.Checked, psCdSep, sField, sValue, msUsrID)
            End If
    ...
    Private Sub btnSel_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSel.Click
        ...
        If sBuf.Length > 0 Then sBuf += msCrLf + msCrLf
