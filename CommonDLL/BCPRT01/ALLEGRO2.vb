...
Public Class ALLEGRO2
    Private Declare Function GetPixel Lib "gdi32" (ByVal hDC As Integer, ByVal X As Long, ByVal Y As Long) As Integer
    Private Declare Auto Function GetDC Lib "user32" Alias "GetDC" (ByVal hwnd As IntPtr) As IntPtr
    Private Declare Function DeleteDC Lib "gdi32" (ByVal hdc As Integer) As Integer

    Private Const mcFile$ = "File : ALLEGRO2.vb, Class : ALLEGRO2" + vbTab
    ...
    Protected Overridable Function fnMakePrtMsg(ByVal ro_Data As STU_BCPRTINFO, _
        ...
        Try
            ...
            If ro_Data.BCCLSCD = login.PRG_CONST.BCCLS_BldCrossMatch Or ro_Data.BCCNT = "B" Or Login.PRG_CONST.BCCLS_BloodBank.StartsWith(ro_Data.BCCLSCD.Substring(0, 1)) Then
            ...
            If ro_Data.BCCLSCD = Login.PRG_CONST.BCCLS_BldCrossMatch Or ro_Data.BCCNT = "B" Then
                '< 용기명 
            ...
            ElseIf Login.PRG_CONST.BCCLS_BloodBank.StartsWith(ro_Data.BCCLSCD.Substring(0, 1)) Then
            ...
            Else
                If ro_Data.BCTYPE = "M" Then
                    ...
                    '< 미생물 검체번호
                    ro_Data.BCNO_MB = "000000-00-0000"
    ...
    Protected Overridable Function fnMakePrtMsg_PIS(ByVal ro_Data As STU_BCPRTINFO, _
        ...
        Try
            ...
            ''< 진료과/병동/병실
            sPrtBuf += "1" + "9" + "1" + "1" + "002" + "0110" + (650 + riLeftPos).ToString.PadLeft(4, "0"c) + ro_Data.DEPTWARD + vbCrLf
            ...
            ''< 환자명 
            For ix As Integer = 0 To ro_Data.PATNM.Length - 1
                sPrtBuf += "1" + "Y" + "1" + "1" + "000" + "0092" + (460 + (ix * 32) + riLeftPos).ToString.PadLeft(4, "0"c) + " " + "IMG" + (ix + 21).ToString.PadLeft(2, "0"c) + vbCrLf
            Next
            ...
            '< 검사명
            sPrtBuf += "1" + "9" + "1" + "1" + "002" + "0030" + (300 + riLeftPos).ToString.PadLeft(4, "0"c) + sTestNms + vbCrLf
            'For ix As Integer = 0 To sTestNms.Length - 1
    ...
    Public Function fnGet_HexValue(ByVal rsValue As String) As String
        Dim sFn$ = "sbImgPrtOut"
        ...
        Try
            ...
            For ix As Integer = 0 To Len(rsValue) - 1
                'Space Check
                Dim sData As String = rsValue.Substring(ix, 1)
                Dim iAscData1 As Integer = Asc(sData)
                Dim sHex As String = Hex(iAscData1).PadRight(2, "0")
    ...
    Public Function fnGet_FontImage(ByVal rsValue As String, ByVal r_Font As Font, ByVal riWidth As Integer, ByVal riHeight As Integer) As String
        ...
        Try
            ...
            'Me.picFont.Image = bmpEP
            ''If IO.File.Exists(sFilePath + rsValue + ".bmp") Then
            ''    IO.File.Delete(sFilePath + rsValue + ".bmp")
            ''End If

            'Me.picFont.Image.Save(sFilePath + rsValue + ".bmp")
