...
#Region " Windows Form 디자이너에서 생성한 코드 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.lblKey00.Font = New System.Drawing.Font("굴림", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(129, Byte))
        ...
        Me.lblKey17.Font = New System.Drawing.Font("굴림", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(129, Byte))
    ...
    Private Sub btnOk_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
        ...
        With spdDiffCount
            ...
            If iCount < Val(cbxMaxCount.Text) Then
                If MsgBox("설정한 Max Count " & cbxMaxCount.Text & " 보다 작은 숫자 " & iCount & " 입니다." & Chr(13) & Chr(10) & " 결과 입력하시겠습니까?", MsgBoxStyle.YesNo) = MsgBoxResult.No Then
                    Exit Sub
                End If
                bMaxCount = False
            End If
