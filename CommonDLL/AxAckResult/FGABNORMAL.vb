...
Public Class FGABNORMAL
    Inherits System.Windows.Forms.Form
    Private Const msFile As String = "File : FGUNFITSPC.vb, Class : AxAckResult" + vbTab
    ...
    Private Sub sbDisplay_slip()
        ...
        Try
            Dim dt As DataTable = LISAPP.COMM.cdfn.fnGet_Slip_List(, False, mbBloodBank, mbMicroBio)

            Me.cboSlip.Items.Clear()
            For ix As Integer = 0 To dt.Rows.Count - 1
                Me.cboSlip.Items.Add("[" + dt.Rows(ix).Item("slipcd").ToString + "] " + dt.Rows(ix).Item("slipnmd").ToString)

                If dt.Rows(ix).Item("slipcd").ToString.Trim = msPartSlip Then Me.cboSlip.SelectedIndex = ix
            Next
...
#Region " Windows Form 디자이너에서 생성한 코드 "
    ...
    Public Sub New(ByVal rsBcNo As String, ByVal rsPartSlip As String, ByVal rbBloodBank As Boolean, ByVal rbMicroBio As Boolean, ByVal ra_TclsCds As ArrayList)
        MyBase.New()
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FGABNORMAL))
        ...
        'GroupBox2
        '
        Me.GroupBox2.Controls.Add(Me.cboSlip)
        ...
        Me.GroupBox2.Size = New System.Drawing.Size(618, 36)
        ...
        Me.cboSlip.Items.AddRange(New Object() {"자동화계", "특수계1", "툭스계2"})
        Me.cboSlip.Location = New System.Drawing.Point(84, 11)
        Me.cboSlip.Name = "cboSlip"
        Me.cboSlip.Size = New System.Drawing.Size(200, 20)
        Me.cboSlip.TabIndex = 4
        '
        'Label39
        '
        ...
        Me.Label39.Location = New System.Drawing.Point(11, 11)
        ...
        Me.btnToggle.Location = New System.Drawing.Point(563, 11)
        ...
        Me.txtSearch.Location = New System.Drawing.Point(425, 11)
        ...
        Me.lblSearch.Location = New System.Drawing.Point(344, 11)
        ...
        Me.GroupBox4.Controls.Add(Me.cboCmtCont)
        ...
        Me.txtCmtCd.Location = New System.Drawing.Point(102, 34)
        ...
        Me.cboCmtCont.Location = New System.Drawing.Point(175, 34)
        Me.cboCmtCont.Name = "cboCmtCont"
        Me.cboCmtCont.Size = New System.Drawing.Size(244, 20)
        ...
        Me.lblUserNm.Location = New System.Drawing.Point(394, 4)
        ...
        Me.lblUserId.Location = New System.Drawing.Point(320, 5)
        ...
        Me.btnReg.Location = New System.Drawing.Point(708, 4)
        ...
        Me.btnClear.Location = New System.Drawing.Point(844, 4)
        ...
        Me.btnExit.Location = New System.Drawing.Point(952, 4)
...
#Region " 메인 버튼 처리 "
    ...
    Private Sub btnReg_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnReg.Click
        ...
        Try
            ...
            If sPartSlip = "" Then
                With Me.spdList
                    For iRow As Integer = 1 To .MaxRows
                        ...
                        .Col = .GetColFromID("partslip") : Dim sSlipCd As String = .Text
            ...
            If LISAPP.APP_R.AbnFn.fnExe_Abnormal_Reg(Me.lblBCNO.Text.Replace("-", ""), sPartSlip, "-", "-", USER_INFO.USRID, Me.txtCmtCont.Text, Me.txtCmtCd.Text.Trim, Me.lblRegNo.Text, sLisSeq) Then
                Dim oForm = New FGSMSSEND()
                Dim sSMSMsg As String = ""

                If sTestGbn = "LM205" Then
                    'sSMSMsg = "[Critical value 통보] 등록번호[" + Me.lblRegNo.Text + "]  이름[" + Me.lblPatNm.Text + "] AFB stain 최종보고 결과를 확인해주세요." + vbCrLf
                    sSMSMsg = "등록번호[" + Me.lblRegNo.Text + "]  이름[" + Me.lblPatNm.Text + "] AFB stain 최종보고 결과를 확인해주세요." + vbCrLf
                Else
                ...
                End If
            Else
                MsgBox("특이결과 등록시 오류가 발생했습니다.!!", MsgBoxStyle.Exclamation)
            End If
...
#Region " Form내부 함수 "
    ...
    Private Sub sbFormInitialize()
        ...
        Try
            ...
            Call sbDisplay_slip()
            Call sbDisplay_CmtCont()  ''' 취소사유 콤보에 select 값 없으면 에러남 
    ...
    Private Function fnValidation() As Boolean
        ...
        Try
            ...
            '    MsgBox("[특이결과 등록] 권한이 없어 처리할 수 없습니다", MsgBoxStyle.Information, Me.Text)
            '    Return False
            'End If
    ...
    Private Sub sbDisplay_DataView(ByVal rsBcNo As String)
        ...
        Try
            ...
            Dim dt As DataTable = LISAPP.APP_R.AbnFn.fnGet_Abnormal_RstInfo(rsBcNo, Ctrl.Get_Code(Me.cboSlip))
            ...
            With spdList
                ...
                For ix As Integer = 0 To dt.Rows.Count - 1
                    ...
                    .Col = .GetColFromID("partslip") : .Text = dt.Rows(ix).Item("partslip").ToString.Trim
                    ...
                    .Col = .GetColFromID("viewrst") : .Text = dt.Rows(ix).Item("viewrst").ToString.Trim
                    ...
                    Select Case dt.Rows(ix).Item("rstflg").ToString
                        ...
                        Case "2"
                            .Col = .GetColFromID("rstflg") : .Text = "○"
                        Case "3"
                            .Col = .GetColFromID("rstflg") : .ForeColor = Drawing.Color.DarkGreen : .Text = "◆"
                        Case Else
                            .Col = .GetColFromID("rstflg") : .Text = ""
                    End Select

                    .Col = .GetColFromID("hlmark") : .Text = dt.Rows(ix).Item("hlmark").ToString().Trim
                    ...
                    .Col = .GetColFromID("panicmark") : .Text = dt.Rows(ix).Item("panicmark").ToString().Trim
                    If dt.Rows(ix).Item("panicmark").ToString() = "P" Then
                        .BackColor = Color.FromArgb(150, 150, 255)
                        .ForeColor = Color.FromArgb(255, 255, 255)
                    End If

                    .Col = .GetColFromID("deltamark") : .Text = dt.Rows(ix).Item("deltamark").ToString().Trim
                    If dt.Rows(ix).Item("deltamark").ToString() = "D" Then
                        .BackColor = Color.FromArgb(150, 255, 150)
                        .ForeColor = Color.FromArgb(0, 128, 64)
                    End If

                    .Col = .GetColFromID("criticalmark") : .Text = dt.Rows(ix).Item("criticalmark").ToString()
                    If dt.Rows(ix).Item("criticalmark").ToString() = "C" Then
                        .BackColor = Color.FromArgb(255, 150, 255)
                        .ForeColor = Color.FromArgb(255, 255, 255)
                    End If

                    .Col = .GetColFromID("alertmark") : .Text = dt.Rows(ix).Item("alertmark").ToString().Trim
                    If dt.Rows(ix).Item("alertmark").ToString() <> "" Then
                        .BackColor = Color.FromArgb(255, 255, 150)
                        .ForeColor = Color.FromArgb(0, 0, 0)
                    End If

                    If malTcslCds.Contains(dt.Rows(ix).Item("testcd").ToString.Trim) Then
    ...
    Private Function fnSelOrdList(ByRef ra_OrdList As ArrayList) As Boolean
        Dim sFn As String = "Private Sub fnSelOrdList( ArrayList)"
        ...
        Try
            ...
            With spdList
                For intCnt = 1 To .MaxRows
                    .Row = intCnt
                    .Col = .GetColFromID("rstflg") : strRstStat = .Text
                    .Col = .GetColFromID("tnmd") : strOrdNm = .Text
                    ...
                    If .Text = "1" Then
                        ...
                        objOrdList.REGNO = Me.lblRegNo.Text

                        .Col = .GetColFromID("bcno") : objOrdList.BCNO = .Text
                        .Col = .GetColFromID("tclscd") : objOrdList.TCLSCD = .Text
                        .Col = .GetColFromID("spccd") : objOrdList.SPCCD = .Text
                        .Col = .GetColFromID("tcdgbn") : objOrdList.TCDGBN = .Text
                        .Col = .GetColFromID("iogbn") : objOrdList.IOGBN = .Text
                        .Col = .GetColFromID("fkocs") : objOrdList.FKOCS = .Text
                        .Col = .GetColFromID("owngbn") : objOrdList.OWNGBN = .Text
                        .Col = .GetColFromID("bcclscd") : objOrdList.BCCLSCD = .Text
                        .Col = .GetColFromID("doctorrmk") : objOrdList.CANCELCMT = .Text

                        '< yjlee
                        .Col = .GetColFromID("tordcd") : objOrdList.TORDCD = .Text
                        '> 
                        .Col = .GetColFromID("spcflg") : objOrdList.SPCFLG = .Text

                        ra_OrdList.Add(objOrdList)
                        fnSelOrdList = True
                    End If
                Next
            End With
            ra_OrdList.TrimToSize()
    ...
    Private Sub sbDisplay_CmtCont()
        ...
        Dim dt As DataTable = LISAPP.COMM.cdfn.fnGet_cmtcont_etc("A", False)
...
#Region " Control Event 처리 "
    ...
    Private Sub cboCancel_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cboCmtCont.KeyPress
    ...
    Private Sub spdList_ButtonClicked(ByVal sender As Object, ByVal e As AxFPSpreadADO._DSpreadEvents_ButtonClickedEvent) Handles spdList.ButtonClicked
        ...
        With spdList
            ...
            Dim sTmp As String = sTnmd + ": " + sViewRst + vbCrLf

            If sChk = "1" Then
                If Me.txtCmtCont.Text.IndexOf(sTmp) < 0 Then Me.txtCmtCont.Text += sTmp
            Else
                If Me.txtCmtCont.Text.IndexOf(sTmp) < 0 Then Me.txtCmtCont.Text = Me.txtCmtCont.Text.Replace(sTmp, "")
            End If
        End With
...
#End Region
    ...
    Private Sub cboCancel_SelectedValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboCmtCont.SelectedValueChanged
        ...
        Try
            ...
            If alList.Count > 0 Then
                ...
                For ix As Integer = 0 To cboCmtCont.Items.Count - 1
                    ...
                    If cboCmtCont.Text = "[" + Me.txtCmtCd.Text + "] " + Me.txtCmtCont.Text Then
                        cboCmtCont.SelectedIndex = ix
                        Exit For
                    End If
                Next
            End If
    ...
    Private Sub FGABNORMAL_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Dim sFn As String = "Handles Me.Load"
