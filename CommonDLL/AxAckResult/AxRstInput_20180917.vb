...
Public Class AxRstInput
            ...
            With spdResult
                ...
                If sDiffCmt <> "" Then
                    ...
                    If Ctrl.Get_Code(Me.cboSlip) <> sPartslip Then
                        ...
                        Next
                    End If
                    If Me.cboSlip.SelectedIndex > 0 Then Me.txtCmtCont.Text += "[" + rsTnmd + "] " + sDiffCmt
                End If
    ...
    Private Function fnChecakReg(ByVal rsRstFlg As String, ByRef raCmtCont As ArrayList) As ArrayList
        ...
        Try
            ...
            Dim sBbtType$ = "", sBldGbn$ = "", sUsrId1$ = "", sUsrId2$ = "", sRst1$ = "", sRst2$ = ""
    ...
    Private Sub sbGet_CvtCmtInfo(ByVal rsBcNo As String, ByVal rbLisMode As Boolean)
        ...
        Try
            ...
            Dim alCvtCmt As ArrayList = LISAPP.COMM.CvtCmt.fnCvtCmtInfo(rsBcNo, alRst, sSlipCd, rbLisMode)
            Dim sCmt$ = ""
            Dim sCmt2 As String = ""
        ...
        Try
            ...
            If alCmtCont.Count > 0 Then
                For ix1 As Integer = 0 To alCmtCont.Count - 1
                    ...
                    If Me.txtCmtCont.Text.IndexOf(CType(alCmtCont.Item(ix1), CMT_INFO).CmtCont) < 0 Then
                        If Me.txtCmtCont.Text <> "" Then
