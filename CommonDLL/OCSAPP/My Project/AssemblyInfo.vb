...
'Version 3.1.10.346 --> 2020/02/22 : 배지바코드 5장 출력되도록 수정
'Version 3.1.10.347 --> 2021/03/22 : 주민번호로 조회 오류 수정
'Version 3.1.10.348 --> 2021/04/19 : 수혈처방조회 처방 저장일시 컬럼 추가 및 데이터 출력

<Assembly: AssemblyVersion("3.1.10.348")> 
