...
Public Class FGOCS01
    ...
    Public Sub sbDisplay_PastTnsInfo()
        Try
            ...
            Dim sBfSlipnm As String = ""
            Dim dt5 As DataTable = OCSAPP.OcsLink.SData.fn_GetPastTnsList(gsRegNo, gsNowDate)
        ...
        Try
            ...
            With spdOpInfo
                ...
                For ix As Integer = 0 To dt6.Rows.Count - 1
                    ...
                    .Col = .GetColFromID("meddept") : .Text = dt6.Rows(ix).Item("meddept").ToString
                    .Col = .GetColFromID("opdrnm") : .Text = dt6.Rows(ix).Item("opdrnm").ToString
                    .Col = .GetColFromID("anstdrnm") : .Text = dt6.Rows(ix).Item("anstdrnm").ToString
                    .Col = .GetColFromID("anethcd") : .Text = dt6.Rows(ix).Item("anethcd").ToString
        ...
        With Me.spdOrdInfo
            If e.col = .GetColFromID("rstval") Then
                ...
                If .Text = "SET검사결과" Then
                    Dim setrstinfo As New FGOCS01_S02
