...
Public Class FGCDHELP_TEST2
    ...
    Private Sub btnCdHelp_test_Click(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    Private Sub cboSpc_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    Private Sub txtTCode_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    ...
    Private Sub btnToggle_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        If Me.lblTest.Text.Trim = "검사코드" Then
            Me.lblTest.Text = " 처방코드"
        Else
    ...
    Private Sub txtTnmd_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Me.txtTnmd.SelectionStart = 0
        Me.txtTnmd.SelectAll()
    End Sub

    Private Sub txtTnmd_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    ...
    Private Sub btnQueryPdf_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnQueryPdf.Click

        Dim frmChild As Windows.Forms.Form
        frmChild = New FGCDHELP_TEST3
