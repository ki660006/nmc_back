Namespace ComLogin
    ...
    Public Class STU_UserSkill
        ...
        Public Function Authority(ByVal rsGrp As String, ByVal riSikSeq As Integer, Optional ByRef rsDesc As String = "") As Boolean
            ...
            Catch ex As Exception
                LISCOM.ComFN.Fn.Log(sFile & sFn, Err)
            End Try
    ...
    Public Class STU_CONST
        Private Const sFile As String = "File : COMMON00.vb, Class : _CONST" + vbTab
        ...
        Public Function PART_RIA() As String
            Try
                Dim dr As DataRow() = m_dt.Select("clsitem = 'B' AND clsval = '9'")
    ...
    Public Class STU_AUTHORITY
        Public Shared mFNReg As String = ""         ' 결과검증권한      
        Public Shared mFNUpdate As String = ""      ' 최종보고 수정 권한
        Public Shared mPDFNReg As String = ""       ' Panic 최종보고 권한
        Public Shared mDFNReg As String = ""        ' Delta 최종보고 권한
        Public Shared mCFNReg As String = ""        ' Critical 최종보고 권한
        Public Shared mAFNReg As String = ""        ' Alert 최종보고 권한
        Public Shared mRstUpdate As String = "1"    ' 결과 수정기능
        Public Shared msID As String = "ACK"        ' 로긴 아이디
        Public Shared msRstClear As String = ""     ' 결과 소거기능
    End Class
