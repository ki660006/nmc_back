...
Public Class APP_SP
    ...
    Public Shared Function fnGet_AddFile_Binary(ByVal rsBcNo As String, ByVal rsTestCd As String, ByVal rsRstNo As String, Optional ByVal rbViewYn As Boolean = False) As String
        ...
        Try
            Dim dbCmd_f As New OracleCommand
            ...
            sSql = ""
            sSql += "SELECT filenm, filelen FROM rrs12m"
            sSql += " WHERE bcno   = :bcno"
            sSql += "   AND testcd = :testcd"
            sSql += "   AND rstno  = :rstno"

            dbCmd_f.Connection = GetDbConnection()
            dbCmd_f.CommandType = CommandType.Text
            dbCmd_f.CommandText = sSql

            dbDA = New OracleDataAdapter(dbCmd_f)
            ...
            sSql = ""
            sSql += "SELECT filebin FROM rrs12m"
            sSql += " WHERE bcno   = '" + rsBcNo + "'"
            sSql += "   AND testcd = '" + rsTestCd + "'"
            sSql += "   AND rstno  = " + rsRstNo

            Dim dbCmd As New oracleCommand(sSql, GetDbConnection())
    ...
    Public Shared Function fnGet_SpcInfo_bcno(ByVal rsBcNo As String) As DataTable
        ...
        Try
            ...
            sSql += "       fn_ack_date_str(j.orddt, 'yyyy-mm-dd hh24:mi') orddt, j.regno,"
            ...
            sSql += "       fn_ack_date_str(j0.colldt, 'yyyy-mm-dd hh24:mi:ss') colldt,"
    ...
    Public Shared Function fnGet_Rst_SpTest_img(ByVal rsBcNo As String) As DataTable
        ...
        Try
            ...
            sSql += "  FROM rr010m a, rf310m b"
            sSql += " WHERE a.bcno       = :bcno"
            sSql += "   AND a.testcd     = b.testcd"
            sSql += "   AND b.stsubexprg = 'IMG'"
            sSql += "   AND NVL(a.rstflg, '0') <> '3'"
            sSql += "   AND a.testcd NOT IN (SELECT testcd FROM rrs10m WHERE bcno = :bcno)"
    ...
    Public Shared Function fnGet_Rst_SpTest(ByVal rsBcNo As String, ByVal rsTestCd As String) As DataTable
        ...
        Try
            ...
            sSql += "  FROM rf310m f, rr010m r LEFT OUTER JOIN"
            sSql += "       rrs10m rs ON (r.bcno = rs.bcno AND r.testcd = rs.testcd)"
    ...
    '-- 특수검사 대상자 조회
    Public Shared Function fnGet_SpcList_Sp_Tk(ByVal rsPartSlip As String, ByVal rsDateS As String, ByVal rsDateE As String, _
                                               ByVal rsOpt As String, ByVal rsTestCds As String, Optional ByVal riOpt As Integer = 0) As DataTable
        ...
        Try
            ...
            If rsOpt = "NR" Then
                ...
                sSql += "       CASE WHEN r.rstflg = '3' THEN 'Y' ELSE 'N' END rstflg, s.spcnmd"
                sSql += "  FROM rf060m f, rj010m j, lf030m s,"
                sSql += "       ("
            ...
            Else
                ...
                sSql += "       fn_ack_get_bcno_full(r.wkymd || NVL(r.wkgrpcd, '') || NVL(r.wkno, '')) workno,"
                sSql += "       fn_ack_date_str(r.tkdt, 'yyyy-mm-dd hh24:mi:ss') tkdt, r.testcd, f.tnmd,"
                sSql += "       CASE WHEN j.rstflg = '3' THEN 'Y' ELSE 'N' END rstflg, s.spcnmd"
                sSql += "  FROM rr010m r, rf060m f, rj010m j, lf030m s"
    ...
    '-- 특수검사 대상자 조회(결과일자)
    Public Shared Function fnGet_SpcList_Sp_RstDt(ByVal rsPartSlip As String, ByVal rsDateS As String, ByVal rsDateE As String, _
                                                  ByVal rsOpt As String, ByVal rsTestCds As String) As DataTable
        Dim sFn As String = ""
    ...
    Public Shared Function fnGet_SpcList_Sp_bcno(ByVal rsBcNo As String, Optional ByVal rsTestCd As String = "") As DataTable
        ...
        Try
            ...
            sSql += "  FROM rf060m f, rj010m j, rr010m r"
            sSql += " WHERE j.bcno    = :bcno"
            sSql += "   AND j.bcno    = r.bcno"
            sSql += "   AND f.testcd  = r.testcd"
            sSql += "   AND f.spccd   = r.spccd"
    ...
    '-- 특수검사 대상자 조회(등록번호)
    Public Shared Function fnGet_SpcList_Sp_Regno(ByVal rsRegNo As String, ByVal rsPartSlip As String, ByVal rsDateS As String, ByVal rsDateE As String, ByVal rsTestCds As String) As DataTable
        Dim sFn As String = ""
        ...
        Try
            ...
            If rsDateS.Length * rsDateE.Length > 0 Then
    ...
    Public Shared Function fnGet_TestList_sp(ByVal rsPartSlip As String, ByVal rsDateS As String, ByVal rsDateE As String) As DataTable
        ...
        Try
            ...
            sSql += "  FROM (SELECT testcd FROM rf310m GROUP BY testcd) f31,"
            ...
            al.Add(New OracleParameter("dates", OracleDbType.Varchar2, rsDateS.Length, ParameterDirection.Input, Nothing, Nothing, Nothing, Nothing, DataRowVersion.Current, rsDateS))
            al.Add(New OracleParameter("datee", OracleDbType.Varchar2, rsDateE.Length, ParameterDirection.Input, Nothing, Nothing, Nothing, Nothing, DataRowVersion.Current, rsDateE + "235959"))
    ...
    Public Shared Function fnGet_TestList_sp(ByVal rsPartSlip As String, ByVal rsDateS As String, ByVal rsDateE As String, _
