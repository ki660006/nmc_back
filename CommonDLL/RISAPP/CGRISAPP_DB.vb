...
Namespace APP_DB
    ...
    Public Class DbFn
        ...
        Public Function GetViewToBCPrt(ByVal rsBcNo As String, Optional ByVal r_dbCn As OracleConnection = Nothing) As String
        ...
        Public Function GetBCPrtToView(ByVal rsBcNo As String, Optional ByVal r_DbCn As OracleConnection = Nothing) As String
        ...
        Public Shared Function ExcuteSql(ByVal r_dbCn As oracleConnection, ByVal r_al_sql As ArrayList, Optional ByVal rbMsgBox As Boolean = True, Optional ByRef riRows As Integer = 0) As Boolean
            ...
            With r_al_sql
                Try
                    ...
                    dbTran = r_dbCn.BeginTransaction()
    ...
    Public Class LogSql
        Private Const msFile As String = "File : CGDA_COMMON, Class : LogSql" & vbTab
