...
Public Class AxCollList_lis
    ...
    Public Function CollectSelCancel(ByVal r_frm As Windows.Forms.Form) As Boolean
        ...
        Dim arlBcNos As ArrayList = fnGet_Checked_BcNos()
        ...
        Try
            ...
            Return frm.Display_Result(r_frm, sIoGbn, arlBcNos)
        ...
        Try
            ...
            Else
                If mbCollBatch Then
                    If rsIoGbn = "I" Then
                        sWhare = "iogbn = 'I'"
                        If rsDeptOrWard <> "" Then sWhare += " AND wardno = '" + rsDeptOrWard + "'"
                    ...
                    Else
                        sWhare = "iogbn = 'O'"
                        If rsDeptOrWard <> "" Then sWhare += " AND deptcd = '" + rsDeptOrWard + "'"
        ...
        Try
            ...
            With spd
                ...
                If mbAllCheck = False Then
                    ...
                    For ix As Integer = 1 To .MaxRows
                        Dim sHopeDay As String = r_dt.Rows(ix - 1).Item("hopeday").ToString
        ...
        Try
            ...
            With spd
                ...
                For i As Integer = 1 To r_dt.Rows.Count
                    ...
                    '.Col = .GetColFromID("passdt") : If .Col > -1 Then .Text = r_dt.Rows(i - 1).Item("passdt").ToString().Trim
                    '.Col = .GetColFromID("passnm") : If .Col > -1 Then .Text = r_dt.Rows(i - 1).Item("passnm").ToString().Trim
