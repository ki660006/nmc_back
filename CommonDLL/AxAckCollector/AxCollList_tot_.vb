...
Public Class AxCollList_tot
    ...
    Public Function CollectSelOrder(ByRef noSunabList As ArrayList, _
        ...
        Try
            ...
            Dim bChange As Boolean = fnFind_Exist_Change(m_dt_ord, fnGet_OrderData(rsRegNo, rsIoGbn, rsDeptOrWard, rsOrdDtS, rsOrdDtE, "0", "0", rsPartGbn, False))
    ...
    Public Sub DisplayOrder(ByVal rsRegNo As String, ByVal rsIoGbn As String, ByVal rsDeptOrWard As String, _
        ...
        Try
            ...
            Dim dt As DataTable = fnGet_OrderData(rsRegNo, rsIoGbn, rsDeptOrWard, rsOrdDt1, rsOrdDt2, _
                                                  rsSpcFlg1, rsSpcFlg2, rsPartGbn, rbHopeday)
    ...
    Private Function fnGet_OrderData(ByVal rsRegNo As String, ByVal rsIoGbn As String, ByVal rsDeptOrWard As String, _
        ...
        Try
            ...
            If mbCollBatch Then
                dt = fnGet_Coll_Order_batch(rsOrdDt1, rsOrdDt2, rsSpcFlg1, rsSpcFlg2, rsIoGbn, rsDeptOrWard)
            Else
                If rsIoGbn = "I" Then
            ...
            If rsPartGbn <> "" Then sWhare += IIf(sWhare = "", "", " AND ").ToString + "partgbn = '" + rsPartGbn + "'"
