        ...
        Catch ex As Exception
            ...
            If iCnt <= 3 Then
                ...
                With stuCStr
                    ...
                    If .DATASOURCE = "NMC" Then     '-- 운영1기
                        .DATASOURCE = "NMC"         '-- 운영2기

                        If Not MdiMain.Frm Is Nothing Then
                            MdiMain.Frm.Text.Replace("NMC", "NMC")  '-- MJOCS1, MJOCS2
                        End If
                        '> add freety 2005/01/10
                    Else
                        .DATASOURCE = "NMC"              '-- MJOCS1

                        If Not MdiMain.Frm Is Nothing Then
                            MdiMain.Frm.Text.Replace("NMC", "NMC")  '-- MJOCS2, MJOCS1
                        End If
                    End If
    ...
    Public Function DbExecuteQuery(ByVal rsSql As String, ByVal r_al_List As ArrayList, ByVal rbText As Boolean, _
        ...
        Try
            With dbCmd
                ...
                If rbText = False And rsSql.StartsWith("pkg_") Then
                    .Parameters.Add(New OracleParameter("io_cursor", OracleType.Cursor, Nothing, ParameterDirection.Output, Nothing, Nothing, Nothing, Nothing, DataRowVersion.Current, ""))
                End If
            End With
